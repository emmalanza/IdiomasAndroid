...
public class NumerosNativoJugar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb_1.setText(R.string.uno_n);
        rb_2.setText(R.string.cinco_n);
        rb_3.setText(R.string.tres_n);
    }
    ...
    public void cambiar(){
        ...
        if(numero.equals("2")){
            ...
            rb_1.setText(R.string.dos_n);
            rb_2.setText(R.string.cinco_n);
            rb_3.setText(R.string.diez_n);
        }else if(numero.equals("3")){
            imagen.setImageResource(R.drawable.tres);
            rb_1.setText(R.string.siete_n);
            rb_2.setText(R.string.tres_n);
            rb_3.setText(R.string.ocho_n);
        }else if(numero.equals("4")){
            imagen.setImageResource(R.drawable.cuatro);
            rb_1.setText(R.string.uno_n);
            rb_2.setText(R.string.cuatro_n);
            rb_3.setText(R.string.dos_n);
        }else if(numero.equals("5")){
            imagen.setImageResource(R.drawable.cinco);
            rb_1.setText(R.string.ocho_n);
            rb_2.setText(R.string.diez_n);
            rb_3.setText(R.string.cinco_n);
        }else if(numero.equals("6")){
            imagen.setImageResource(R.drawable.seis);
            rb_1.setText(R.string.cinco_n);
            rb_2.setText(R.string.tres_n);
            rb_3.setText(R.string.seis_n);
        }else if(numero.equals("7")){
            imagen.setImageResource(R.drawable.siete);
            rb_1.setText(R.string.siete_n);
            rb_2.setText(R.string.seis_n);
            rb_3.setText(R.string.dos_n);
        }else if(numero.equals("8")){
            imagen.setImageResource(R.drawable.ocho);
            rb_1.setText(R.string.ocho_n);
            rb_2.setText(R.string.cinco_n);
            rb_3.setText(R.string.cuatro_n);
        }else if(numero.equals("9")){
            imagen.setImageResource(R.drawable.nueve);
            rb_1.setText(R.string.seis_n);
            rb_2.setText(R.string.uno_n);
            rb_3.setText(R.string.nueve_n);
    ...
    public void comprobar(){
        ...
        if(numero.equalsIgnoreCase("1") && rb_1.isChecked()){
            aciertos++;
