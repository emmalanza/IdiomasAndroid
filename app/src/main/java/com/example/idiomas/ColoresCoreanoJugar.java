...
public class ColoresCoreanoJugar extends AppCompatActivity {
   ...
   protected void onCreate(Bundle savedInstanceState) {
        ...
        rb_1.setText(R.string.amarillo_c);
    ...
    public void cambiar(){
        ...
        if(color.equals("AMARILLO")){
            ...
            tv_color.setTextColor(getResources().getColor(R.color.blanco));
            rb_1.setText(R.string.rojo_c);
            rb_2.setText(R.string.negro_c);
            rb_3.setText(R.string.amarillo_c);
        }else if(color.equals("VERDE")){
            tv_color.setBackgroundColor(getResources().getColor(R.color.verde));
            tv_color.setTextColor(getResources().getColor(R.color.blanco));
            rb_1.setText(R.string.verde_c);
            rb_2.setText(R.string.rojo_c);
            rb_3.setText(R.string.rosa_c);
        }else if(color.equals("AZUL")){
            tv_color.setBackgroundColor(getResources().getColor(R.color.azul));
            tv_color.setTextColor(getResources().getColor(R.color.blanco));
            rb_1.setText(R.string.amarillo_c);
            rb_2.setText(R.string.verde_c);
            rb_3.setText(R.string.azul_c);
        }else if(color.equals("ROSA")){
            tv_color.setBackgroundColor(getResources().getColor(R.color.rosa));
            tv_color.setTextColor(getResources().getColor(R.color.blanco));
            rb_1.setText(R.string.rosa_c);
            rb_2.setText(R.string.verde_c);
            rb_3.setText(R.string.rojo_c);
        }else if(color.equals("MARRÓN")){
            tv_color.setBackgroundColor(getResources().getColor(R.color.marron));
            tv_color.setTextColor(getResources().getColor(R.color.blanco));
            rb_1.setText(R.string.marron_c);
            rb_2.setText(R.string.gris_c);
            rb_3.setText(R.string.morado_c);
