...
public class NumerosSinoJugar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb_1.setText(R.string.uno_sc);
        rb_2.setText(R.string.cinco_sc);
        rb_3.setText(R.string.dos_sc);
    }
    ...
    public void cambiar(){
        ...
        if(numero.equals("2")){
            ...
            rb_1.setText(R.string.dos_sc);
            rb_2.setText(R.string.seis_sc);
            rb_3.setText(R.string.nueve_sc);
        }else if(numero.equals("3")){
            imagen.setImageResource(R.drawable.tres);
            rb_1.setText(R.string.ocho_sc);
            rb_2.setText(R.string.tres_sc);
            rb_3.setText(R.string.siete_sc);
        }else if(numero.equals("4")){
            imagen.setImageResource(R.drawable.cuatro);
            rb_1.setText(R.string.uno_sc);
            rb_2.setText(R.string.cuatro_sc);
            rb_3.setText(R.string.dos_sc);
        }else if(numero.equals("5")){
            imagen.setImageResource(R.drawable.cinco);
            rb_1.setText(R.string.ocho_sc);
            rb_2.setText(R.string.diez_sc);
            rb_3.setText(R.string.cinco_sc);
        }else if(numero.equals("6")){
            imagen.setImageResource(R.drawable.seis);
            rb_1.setText(R.string.siete_sc);
            rb_2.setText(R.string.cuatro_sc);
            rb_3.setText(R.string.seis_sc);
        }else if(numero.equals("7")){
            imagen.setImageResource(R.drawable.siete);
            rb_1.setText(R.string.siete_sc);
            rb_2.setText(R.string.cinco_sc);
            rb_3.setText(R.string.uno_sc);
            ...
            rb_1.setText(R.string.seis_sc);
            rb_2.setText(R.string.dos_sc);
            rb_3.setText(R.string.nueve_sc);
        }else if(numero.equals("10")){
            imagen.setImageResource(R.drawable.diez);
            rb_1.setText(R.string.siete_sc);
            rb_2.setText(R.string.diez_sc);
            rb_3.setText(R.string.tres_sc);
        }
